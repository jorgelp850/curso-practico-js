...
// Se captura los datos del html y se guardan los valores dentro de una variable
   const entrada = document.getElementById("inputMediana");
   const medianaValue = entrada.value;
...
// Creamos la funcion esPar para verificar si la lista es par o impar
    ...
    let mediana;
    // Si la lista es par procedemos a hallar la mediana mediante esta forma de lo contrario seguiriamos con el else
